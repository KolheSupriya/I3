        ...
        public static void UserMenu()
        {
            ...
            while (user_choice != 0 )
            {
                ...
                switch (user_choice)
                {
                    ...
                    case 3:
                        {
                            ...
                            var findUserData = ctx.USERS.First(x => x.User_Name == Console.ReadLine());
                            var findProductData = ctx.PRODUCTS.First(x => x.Products_ID == findUserData.Product_Access);

                            //Console.WriteLine(findProductAccess.SubProduct_Name);

                            //int productId = 3;

                            //var find = ctx.PRODUCTS.First(x => x.Products_ID == Convert.ToInt32(findProductAccess.Product_Access));
                    ...
                    case 5:
                        {
                            Console.WriteLine("Enter product name you wish to delete: ");
                            int Product_ID = Convert.ToInt32(Console.ReadLine());


                            PRODUCTS deleteProduct = new PRODUCTS() { Products_ID =Product_ID };
